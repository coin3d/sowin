...
SoWinRenderArea::afterRealizeHook(void)
{
  ...
  if (SoWinSpaceball::exists())
    this->registerDevice(new SoWinSpaceball);
}
...
{
  if (enable) {
    PRIVATE(this)->normalManager->setRenderCallback(SoWinRenderAreaP::renderCB, this);
    PRIVATE(this)->overlayManager->setRenderCallback(SoWinRenderAreaP::renderCB, this);
  }
  else {
