...
float SoWinFlyViewerP::calculateChangeInTime()
{
  SbTime thisrender; 
...
void SoWinFlyViewerP::updateCurrentSpeed( float dt )
{
...
void
SoWinFlyViewerP::incrementMaxSpeed()
{
...
void
SoWinFlyViewerP::decrementMaxSpeed()
{	
  this->max_speed_factor--;
  updateMaxSpeed();
}
...
void SoWinFlyViewerP::updateSpeedScalingFactor()
{
...
void SoWinFlyViewerP::stopMoving()
{
  maxspeed = 0;
  currentspeed = 0; 
  max_speed_factor = 0;
...
void SoWinFlyViewerP::updateMaxSpeed()
{
