...
// src/Inventor/Win/SoAny.h.  Generated from SoAny.h.in by configure.
...
public:
  ...
  SoWin::FatalErrorCB * setFatalErrorHandler(SoWin::FatalErrorCB * cb, void * userdata);
  SbBool invokeFatalErrorHandler(SbString errmsg, SoWin::FatalErrors errcode);
